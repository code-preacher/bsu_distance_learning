...
$qk=mysqli_query($con,"select * from reference where matno='".$_SESSION['user_id']."' order by id desc");
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="row page-titles">
        <div class="col-md-5 align-self-center">
          ...
          <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="javascript:void(0)">View Payment HIstory</a></li>
                      ...
                      <tbody>
                        ...
                        while ($r=mysqli_fetch_array($qk)) {
                          ...
                          <tr>
                           ...
                           if ($r['status']=='1') {
                             echo "Used and Validated";
                           } else {
                             echo "Unused and not Validated";
                           }
