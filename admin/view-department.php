...
$qk=mysqli_query($con,"select * from department order by id desc");
?>
<!DOCTYPE html>
<html lang="en">
                                    ...
                                    <tbody>
                                        ...
                                        while ($r=mysqli_fetch_array($qk)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="edit-department.php?id=<?php echo $r['id']?>" onClick="return confirm('Are you sure you want to edit this department ?')"><i class="fa fa-edit text-primary"></i></a></td>
                                                
                                                <td><a href="delete-department.php?id=<?php echo $r['id']?>" onClick="return confirm('Are you sure you want to delete this department ?')"><i class="fa fa-bitbucket text-danger"></i></a></td>
