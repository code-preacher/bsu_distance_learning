...
$qk=mysqli_query($con,"select * from session_log where level='lecturer' order by id desc");
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    ...
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">View Lecturer Session Log</a></li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-title">
                                    <h4>VIEW LECTURER SESSION LOG</h4>

                                    <p>
                                     
                                        <?php if (!empty($_SESSION['stlmsg'])) {
                                            echo $_SESSION['stlmsg'];
                                            $_SESSION['stlmsg']="";
                                        } 
                                        ?>
                                    </p>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            while ($r=mysqli_fetch_array($qk)) {
                                             ...
                                             <td><a href="delete-student-log.php?id=<?php echo $r['id']?>" onClick="return confirm('Are you sure you want to delete this department ?')"><i class="fa fa-bitbucket text-danger"></i></a></td>
