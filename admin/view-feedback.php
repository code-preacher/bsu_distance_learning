...
$qk=mysqli_query($con,"select * from feedback order by id desc");
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    ...
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">View Feedback</a></li>
                                    ...
                                    <tbody>
                                        ...
                                        while ($r=mysqli_fetch_array($qk)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="delete-feedback.php?id=<?php echo $r['id']?>" onClick="return confirm('Are you sure you want to delete this Feedback ?')"><i class="fa fa-bitbucket text-danger"></i></a></td>
