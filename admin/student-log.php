...
$qk=mysqli_query($con,"select * from session_log where level='student' order by id desc");
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="row page-titles">
        <div class="col-md-5 align-self-center">
          ...
          <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="javascript:void(0)">View Student Session Log</a></li>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-title">
                  <h4>VIEW STUDENT SESSION LOG</h4>
