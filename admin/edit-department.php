...
$ta=mysqli_query($con,"select dept_name from department where id='".$_GET['id']."'");
$tb=mysqli_fetch_array($ta);

if(isset($_POST['sub'])){

    $department=strtoupper($_POST['department']);
    $qu=mysqli_query($con,"update department set dept_name='$department' where id='".$_GET['id']."' ");

    if($qu){
        $_SESSION['dpmsg']='<span style="color:green;">'."Department was successfully Updated".'</span>';
    }
    else{
        $_SESSION['dpmsg']='<span style="color:red;">'."Department was not successfully Updated".'</span>'; 
                                    ...
                                    <div class="basic-form">
                                        <form action="#" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control input-rounded" name="department"  value="<?php  echo $tb['dept_name'];?>" required="required">
                                            </div>
