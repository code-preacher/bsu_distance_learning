...
$qk=mysqli_query($con,"select * from reference where status='1' order by id desc");
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    ...
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">View Used Reference</a></li>
