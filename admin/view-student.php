...
$qk=mysqli_query($con,"select * from student order by id desc");
?>
<!DOCTYPE html>
<html lang="en">
                                        ...
                                        <tbody>
                                            ...
                                            while ($r=mysqli_fetch_array($qk)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="edit-student.php?id=<?php echo $r['id']?>" onClick="return confirm('Are you sure you want to edit this student ?')"><i class="fa fa-edit text-primary"></i></a></td>
                                                    
                                                    <td><a href="delete-student.php?id=<?php echo $r['id']?>" onClick="return confirm('Are you sure you want to delete this student?')"><i class="fa fa-bitbucket text-danger"></i></a></td>
