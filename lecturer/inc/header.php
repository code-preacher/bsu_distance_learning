...
<?php
include '../config.php';
$q=mysqli_query($con,"select * from lecturer where email='".$_SESSION['user_id']."'");
                ...
                <li class="nav-item hidden-sm-down search-box"> <a class="nav-link hidden-sm-down text-muted  " href="javascript:void(0)"><i class="ti-search"></i></a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <li class="nav-item dropdown">
                         ...
                         Hello Lecturer,  <?php echo $qr['sname'].' '.$qr['mname'].' '.$qr['fname'];  ?>   
                         <div class="dropdown-menu dropdown-menu-right animated zoomIn">
                            <ul class="dropdown-user">
                                <li><a href="../lecturer/profile.php"><i class="ti-user"></i> Profile</a></li>
                                
                                <li><a href="../lecturer/logout.php" onClick="return confirm('Are you sure you want to logout ?')"><i class="fa fa-power-off"></i> Logout</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
